        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="md:text-right">
            ...
            <div className="space-y-2">
              <a href="https://zoozo-interview-bot.lovable.app/" target="_blank" rel="noopener noreferrer" className="block text-muted-foreground hover:text-primary transition-colors">V The AI Interview Simulator</a>
            </div>
          </div>
        </div>
